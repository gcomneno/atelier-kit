...
- rinomina titolo del primo pezzo e della prima collezione;
...
Poi in studio → **Pezzi** → campo immagine, es. `/images/items/simba.jpg`.
...
| **Pezzi** | Testo, meta (habitat, dieta, curiosità), status (`in mostra`), foto per ogni animale |
| **Collezioni** | Crea aree: Savana africana, Mondo polare, Fattoria didattica, Bosco… **e assegna gli animali** |

> `item:new` crea i pezzi ma **non** li mette nelle collezioni: le collezioni vanno configurate in studio.
...
> Il sito è online. Per aggiornare un animale o un testo: apri **Atelier Desktop**, scegli la cartella del parco, clicca **Open studio**. Per foto nuove, inviale all’operatore o caricale in **Pezzi**.
