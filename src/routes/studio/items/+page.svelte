<script>
  import { Button, FormActions, PageIntro, Panel, ReorderActions, Surface } from 'giadaware-ui-components/studio';
          ...
          {#each orderedIds as itemId, index (itemId)}
            ...
            <li>
              ...
              <div class="order-actions">
                <ReorderActions
                  size="compact"
                  moveUpLabel={t('studio.items.moveUp', { position: index + 1 })}
                  moveDownLabel={t('studio.items.moveDown', { position: index + 1 })}
