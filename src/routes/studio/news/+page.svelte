...
<Panel title={t('studio.news.title')} id="news" class="atelier-studio-panel">
          ...
          {#each orderedIds as postId, index (postId)}
            ...
            <li>
              ...
              <div class="order-actions">
                <ReorderActions
                  size="compact"
                  moveUpLabel={t('studio.news.moveUp', { position: index + 1 })}
                  moveDownLabel={t('studio.news.moveDown', { position: index + 1 })}
