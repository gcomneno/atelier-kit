<script>
  ...
  const isActiveGroup = (prefixes) => prefixes.some((prefix) => pathname.startsWith(prefix));
</script>
...
<style>
  ...
  .studio-nav a:hover {
    background: rgb(45 108 223 / 0.08);
  }

  .studio-nav a.active {
    background: rgb(45 108 223 / 0.16);
    color: #143870;
    font-weight: 600;
  }

  .sub-list.active-group {
    border-left: 2px solid rgb(45 108 223 / 0.35);
