...
export default {
  studio: {
    ...
    accessGuide: {
      ...
      publishWhenReady:
        'Open Publish readiness in the studio and click Put site online when your content is ready.',
      keepBackups:
    ...
    site: {
      ...
      appearance: {
        ...
        headingColorHint: 'Section headings, catalog cards and other secondary titles on the public site.',
        headerTitleColor: 'Header title color',
        headerTitleColorHint: 'Site name or logo text in the top navigation bar.',
        introTitleColor: 'Intro title color',
        introTitleColorHint: 'Main home page heading below the header.',
        ...
        backgroundFit: 'Background layout',
        backgroundFitTop: 'Top (cover)',
        backgroundFitCenter: 'Center (cover)',
        backgroundFitContain: 'Fit (contain)',
        backgroundFitHint: 'How the background image fills the page behind the content.',
        save: 'Save appearance'
      },
      identity: {
        title: 'Site identity',
        intro: 'Header title, home heading, tagline and home-page messages for visitors.',
        headerTitle: 'Header title',
        headerTitleHint: 'Shown in the top navigation bar. Leave empty to hide text when a logo is set.',
        introTitle: 'Intro title',
        introTitleHint: 'Main heading on the home page below the header.',
        headerLogo: 'Header logo (optional)',
        headerLogoHint: 'JPG, PNG or WebP. Saved under static/images/site/header-logo.*',
      ...
      nextSteps: {
        ...
        intro: 'Review publish readiness in the studio and put the site online with one button.',
    ...
    readiness: {
      ...
      livePendingEmpty: 'No new local changes. You can still refresh the live site from the latest saved version.',
      liveCommitsAhead: '{count} saved update(s) waiting to go online.',
      liveRun: 'Put site online',
      liveRunning: 'Updating live site…',
      ...
      liveCommitOk: 'Changes saved.',
      liveSkipCommit: '→ No new files to save (sending existing updates).',
      liveNoCommitNeeded: '→ No new save needed.',
    ...
    itemsEdit: {
      ...
      galleryHint:
        'Reorder gallery images shown on the item page. The row with role “cover” is used as the cover; otherwise the first image is used.',
      galleryFile: 'Image path',
      galleryAlt: 'Image description',
      galleryRole: 'Role',
  ...
  publish: {
    ...
    vercelCliMissing:
      'Local Vercel CLI not found at {path}. Run npm ci before deploying; production deploy will not download an undeclared CLI.',
  ...
  validate: {
    ...
    newsReadingBlocksMustBeArray:
      '{source}: reading_blocks must be an array.',
    newsReadingBlocksMustNotBeEmpty:
      '{source}: reading_blocks must contain at least one block.',
    newsReadingBlockMustBeObject:
      '{blockSource}: block must be an object.',
    newsReadingBlockTypeInvalid:
      '{blockSource}: type "{value}" is not a supported structured-reading block type.',
    newsReadingColophonRoleInvalid:
      '{blockSource}: colophon role "{value}" is not supported.',
    newsReadingBlockTextInvalid:
      '{blockSource}: text must be a non-empty string.',
    newsReadingBlockDropCapInvalid:
      '{blockSource}: drop_cap must be a boolean when present.',
    newsReadingBlockDropCapOnlyParagraph:
      '{blockSource}: drop_cap is allowed only on paragraph blocks.',
    newsReadingBlockRoleOnlyColophon:
      '{blockSource}: role is allowed only on colophon blocks.'
  },
  wizard: {
    usageTitle: 'Usage:',
  ...
  visitor: {
    ...
    visitorBrief: {
      ...
      copyAndOpenInstagram: 'Copy and open Instagram',
      copyAndOpenFacebook: 'Copy and open Facebook',
      copyAndOpenSuccess: 'Message copied: paste it into the conversation.',
      copyError: 'Could not copy automatically. Select and copy the brief manually.',
      popupError: 'Message copied, but the profile could not be opened. Open it manually and paste the message.',
