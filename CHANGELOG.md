...
- Keep the applied Kit version in the tracked `.atelier-kit-version` file so client deploys retain the correct footer version after upgrades ([#185](https://github.com/gcomneno/atelier-kit/pull/185)).
